...
the input that will be provided to your solution. 

The output is the resulting outputs for Map model and MapReduce model. The file output_mr.txt is the output for
